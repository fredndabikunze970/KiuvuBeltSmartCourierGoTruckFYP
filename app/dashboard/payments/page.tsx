...
export default function PaymentsPage() {
  ...
  const paymentMethods = [
    { id: "mobile_money", name: "Mobile Money", icon: Smartphone, description: "MTN, Airtel, or other mobile money" },
    { id: "card", name: "Credit/Debit Card", icon: CreditCard, description: "Visa, MasterCard, or other cards" },
    { id: "bank_transfer", name: "Bank Transfer", icon: Building, description: "Direct bank transfer or wire" },
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      ...
      // FIXED: Use snake_case field names to match API expectations
      // Transaction reference is now handled by the API automatically
      const requestBody = {
    ...
    <ProtectedRoute allowedRoles={["admin", "agent"]}>
      <DashboardLayout>
        <div className="space-y-6">
          ...
          {/* Payment Confirmation Modal - UPDATED (Transaction Reference Removed) */}
          <Dialog open={confirmModalOpen} onOpenChange={setConfirmModalOpen}>
            <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  Review payment details and select payment method. Transaction reference is auto-generated.
                </DialogDescription>
              </DialogHeader>
              ...
              {selectedPayment && (
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div>
                        ...
                        <p className="font-medium text-sm">{selectedPayment.payment_id}</p>
                      </div>
                      <div>
                        <span className="text-gray-600">Package ID:</span>
                        <p className="font-medium text-blue-600 text-sm">{selectedPayment.package_id}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="font-medium text-sm">{selectedPayment.transaction_reference}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="border rounded-lg p-3">
                      ...
                      <div className="text-sm space-y-1">
                        ...
                        <p className="text-gray-500">{selectedPayment.sender_phone || 'N/A'}</p>
                      </div>
                    </div>
                    <div className="border rounded-lg p-3">
                      <h4 className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
                      ...
                      <div className="text-sm space-y-1">
                        ...
                        <p className="text-gray-500">{selectedPayment.receiver_phone || 'N/A'}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border rounded-lg p-3">
                    <h4 className="font-semibold text-gray-900 mb-2">Select Payment Method *</h4>
                    <div className="grid grid-cols-2 gap-2">
                      {paymentMethods.map((method) => {
                        ...
                        return (
                          <div
                            key={method.id}
                            className={`border-2 rounded-lg p-3 cursor-pointer transition-all ${selectedPaymentMethod === method.id
                          ...
                          >
                            <div className="flex items-center gap-2">
                              <div className={`p-1.5 rounded-full ${selectedPaymentMethod === method.id
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-gray-500 leading-tight mt-0.5">{method.description}</p>
                              </div>
                            </div>
                          </div>
                        )
                  ...
                  <div className="border rounded-lg p-3">
                    ...
                    <textarea
                      ...
                      className="w-full h-16 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm"
                    />
                  </div>
                </div>
              )}
